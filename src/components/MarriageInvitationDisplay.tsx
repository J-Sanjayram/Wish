    ...
    <div className="min-h-screen bg-gradient-to-br from-rose-200 via-pink-100 to-purple-200 relative overflow-hidden">
      ...
      <div className={`relative z-10 min-h-screen flex items-center justify-center p-4 transition-all duration-1000 ${showContent ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        <div className="max-w-6xl w-full">
          ...
          <div className="bg-white/90 backdrop-blur-xl rounded-2xl sm:rounded-3xl shadow-2xl border border-white/30 overflow-hidden">
            {/* Header with Images */}
            <div className="relative h-48 sm:h-64 md:h-80 overflow-hidden">
              {invitation.images.length > 0 ? (
                ...
                <div className="w-full h-full bg-gradient-to-br from-rose-400 to-pink-500 flex items-center justify-center">
                  <div className="text-4xl sm:text-6xl text-white/80">💕</div>
                </div>
              )}
              ...
              <div className="absolute inset-0 pointer-events-none">
                {[...Array(6)].map((_, i) => (
                  <div
                    key={i}
                    className="absolute text-lg sm:text-2xl text-white/60 animate-bounce"
                    style={{
                      left: `${20 + i * 15}%`,
                      top: `${20 + (i % 2) * 40}%`,
            ...
            <div className="p-4 sm:p-6 md:p-8 lg:p-12">
              ...
              <div className="text-center mb-6 sm:mb-8">
                <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4 mb-4 sm:mb-6">
                  <div className="text-center">
                    <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 mb-2">{invitation.male_name}</h2>
                    <div className="w-12 sm:w-16 h-0.5 bg-gradient-to-r from-rose-500 to-pink-500 mx-auto"></div>
                  </div>
                  <div className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-gradient-to-r from-rose-500 to-pink-500 rounded-full flex items-center justify-center animate-pulse">
                    <span className="text-sm sm:text-lg md:text-xl text-white">💕</span>
                  </div>
                  <div className="text-center">
                    <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 mb-2">{invitation.female_name}</h2>
                    <div className="w-12 sm:w-16 h-0.5 bg-gradient-to-r from-rose-500 to-pink-500 mx-auto"></div>
                  </div>
                </div>
                
                <div className="inline-flex items-center gap-2 bg-gradient-to-r from-rose-100 to-pink-100 rounded-full px-4 sm:px-6 py-2 sm:py-3">
                  <span className="text-rose-500 text-sm sm:text-base">✨</span>
                  <span className="text-gray-700 font-semibold text-sm sm:text-base md:text-lg">are getting married!</span>
                  <span className="text-rose-500 text-sm sm:text-base">✨</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 md:gap-8 mb-6 sm:mb-8">
                <div className="bg-gradient-to-br from-rose-50 to-pink-50 rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-rose-100">
                  <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                    <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-r from-rose-500 to-pink-500 rounded-full flex items-center justify-center">
                      <span className="text-white text-sm sm:text-base">📅</span>
                    </div>
                    <h3 className="text-lg sm:text-xl font-bold text-gray-800">Wedding Date</h3>
                  </div>
                  <p className="text-gray-700 text-sm sm:text-base md:text-lg font-semibold">{formatDate(invitation.marriage_date)}</p>
                </div>
                ...
                <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-purple-100">
                  <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                    ...
                    <h3 className="text-lg sm:text-xl font-bold text-gray-800">Venue</h3>
                  </div>
                  <p className="text-gray-700 text-sm sm:text-base md:text-lg font-semibold">{invitation.place}</p>
                </div>
              </div>
              ...
              {invitation.additional_info && (
                <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-yellow-100 mb-6 sm:mb-8">
                  ...
                  <p className="text-gray-700 leading-relaxed text-sm sm:text-base">{invitation.additional_info}</p>
                </div>
              )}

              {/* Music Player */}
              {invitation.song && (
                <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-indigo-100 mb-6 sm:mb-8">
                  <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                    ...
                    <h3 className="text-lg sm:text-xl font-bold text-gray-800">Our Song</h3>
                  </div>
                  <AudioPlayer 
                    song={{
              ...
              <div className="text-center pt-6 sm:pt-8 border-t border-gray-200">
                <p className="text-gray-600 mb-3 sm:mb-4 text-sm sm:text-base">Join us as we celebrate our love and begin our journey together</p>
                <div className="flex items-center justify-center gap-2">
                  <span className="text-rose-500 animate-pulse">💕</span>
                  <span className="text-gray-500 font-medium text-sm sm:text-base">With love and joy</span>
                  <span className="text-rose-500 animate-pulse">💕</span>
                </div>
              </div>
            </div>
